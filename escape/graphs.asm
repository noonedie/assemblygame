...
AddMask PROC, hInst:DWORD, DC: DWORD, bmp:DWORD, left:DWORD, top:DWORD, right:DWORD, bottom:DWORD
	LOCAL hDcMask:DWORD
	LOCAL hBmp:DWORD
	...
	invoke LoadBitmap, hInst, bmp
	mov hBmp, eax
	invoke SelectObject, hDcMask, hBmp
	invoke BitBlt, DC, left, top, rect_width, rect_height, hDcMask, 0, 0, SRCCOPY
